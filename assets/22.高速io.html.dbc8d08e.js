...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从上述零拷贝的实现原理图，我们可以发现，内核读缓冲区到内核写缓冲区的数据拷贝也是没有必要的。有一种特殊的DMAC协处理器：SG-DMAC（Scatter-Gatter DMA Controller）可以解决这个问题。不过这需要特殊硬件的支持。在使用SG-DAMC之后，零拷贝的工作流程变成了如下所示，又减少了1次数据拷贝。</p><p><img src="http://wechatapppro-1252524126.file.myqcloud.com/appnvnpyonz2273/image/ueditor/18949500_1654618235.png" alt="img" loading="lazy"></p><h2 id="三、课后思考题" tabindex="-1"><a class="header-anchor" href="#三、课后思考题" aria-hidden="true">#</a> <strong>三、课后思考题</strong></h2><p>本节讲到mmap技术主要用于文件读写，那么，为什么网络读写不能使用mmap技术？</p>`,36),d=[l];function t(r,p){return a(),e("div",null,d)}const o=n(i,[["render",t],["__file","22.高速io.html.vue"]]);export{o as default};
