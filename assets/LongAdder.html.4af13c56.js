import{_ as e,V as n,W as l,a1 as i}from"./framework.02eddb67.js";const d={},s=i(`<h1 id="累加器" tabindex="-1"><a class="header-anchor" href="#累加器" aria-hidden="true">#</a> <strong>累加器</strong></h1><div class="custom-container tip"><p class="custom-container-title">提示</p><p><strong>如何使用数据分片、哈希优化、去伪共享提高累加器性能？</strong></p></div><p>前面几节中，我们讲到锁、自旋+CAS、原子类。对于如下代码，如果我们希望将其改造成线程安全的，那么该如何来做呢？</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class Counter {
  private long sum;
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="六、思考题" tabindex="-1"><a class="header-anchor" href="#六、思考题" aria-hidden="true">#</a> <strong>六、思考题</strong></h2><p>如果我们希望LongAdder的sum()函数能给出准确、一致的累加和，该如何对LongAdder的代码进行改造？改造之后的代码对性能又有什么影响？</p>`,55),a=[s];function r(c,v){return n(),l("div",null,a)}const t=e(d,[["render",r],["__file","LongAdder.html.vue"]]);export{t as default};
