...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果我们希望统计login()和register()这两个函数的执行时间，那么，简单的做法是：直接修改这两个函数的代码，在函数内部添加时间统计代码，但是，这会导致非业务代码跟业务代码耦合。为了代码的结构更加优美，我们可以使用代理模式，让非业务代码与业务代码解耦，如下所示，代理类UserControllerProxy和原始类UserController实现相同的接口IUserController。UserController类只负责业务功能。UserControllerProxy类负责在业务代码执行前后附加非业务代码，并通过委托的方式，调用原始类来执行业务代码。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class UserControllerProxy implements IUserController {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因为原始类和代理类实现了相同的接口，所以，我们可以轻松将代码中的原始类对象，统一替换为代理类对象。如下代码所示。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 原来的代码
IUserController userController = new UserController();

// 替换之后的代码
IUserController userController = new UserControllerProxy(new UserController());
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>不过，如果原始类并没有实现接口，并且原始类代码并不是我们开发维护的（比如它来自一个第三方的类库），我们也没办法直接修改原始类，给它重新定义一个接口。在这种情况下，我们该如何实现代理模式呢？对这种外部类的扩展，我们一般都是采用继承的方式来实现。这里也不例外。我们让代理类继承原始类，然后扩展附加功能。代码如下所示。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class UserControllerProxy extends UserController {
  private static final Logger logger = LoggerFactory.getLogger(UserControllerProxy.class);
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从上述代码，我们可以发现，基于JDK来实现动态代理主要用到了java.lang.reflect.InvocationHandler接口和java.lang.reflect.Proxy类。其中，InvocationHandler接口比较简单，只包含一个invoke()函数，如下所示。</p><figure><img src="http://wechatapppro-1252524126.file.myqcloud.com/appnvnpyonz2273/image/ueditor/20859900_1655395748.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>简单了解InvocationHandler接口之后，我们再来看下Proxy类。Proxy类要比InvocationHandler复杂很多。使用Proxy类生成代理类和实例化对象的方法如下所示。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// Foo为接口
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>大部分情况下，我们只需要用到代理类的实例化对象，所以，上述代码中的后两行代码可以简化为如下一行代码。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Foo f = (Foo) Proxy.newProxyInstance(Foo.class.getClassLoader(), new Class&lt;?&gt;[] { Foo.class }, handler);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><strong>2）实现原理</strong></p><p>接下来，通过分析newProxyInstance()函数的源码，我们来看下基于JDK的动态代理的底层实现原理。newProxyInstance()函数定义如下所示。newProxyInstance()函数中包含3部分逻辑：生成动态代理类、加载动态代理类到JVM、实例化动态代理类对象。其中，参数loader表示类加载器，用来加载生成的动态代理类。参数interfaces表示接口。JDK依据接口生成动态代理类，接口中包含哪些方法，动态代理类中就包含哪些方法。参数h用于实例化动态代理类对象。</p><figure><img src="http://wechatapppro-1252524126.file.myqcloud.com/appnvnpyonz2273/image/ueditor/84950700_1655395748.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>我们先来看下生成动态代理类的过程。如下代码所示，newProxyInstance()函数调用ProxyGenerator类（JDK提供的生成字节码的类），按照类的字节码格式，生成动态代理类的字节码，并存储到内存（proxyClassFile）中。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 生成动态代理类的名称
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从上述动态代理类的生成过程，我们可以发现，动态代理类具有哪些方法，只跟接口有关，跟原始类没有任何关系。这也是基于JDK实现的动态代理，要求原始类必须有接口定义才行的原因。除此之外，加载到JVM中的类都要有类名，这样才能在实例化对象时按照类名查找到对应的类的定义。静态代理类的类名是程序员指定的，动态代理类的类名是自动生成的。如上代码所示，动态代理类的类名由2部分构成：Proxy+自增编号。比如，如果项目中使用Proxy类生成了两个动态代理类，那么，它们的名称就分别为：Proxy0、Proxy1。</p><p>以上讲解的动态代理类生成的过程如下图所示。</p><figure><img src="http://wechatapppro-1252524126.file.myqcloud.com/appnvnpyonz2273/image/ueditor/67791600_1655395749.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>上图只展示动态代理类大概的样子，那么，动态代理类具体长什么样子呢？每个函数都是如何实现的呢？我们可以将通过ProxyGenerator类生成的动态代理类的字节码，保存在文件中，然后再通过反编译工具，得到对应的Java文件。这样就能知道动态代理类具体长什么样子了。动态代理类字节码的保存方法如下代码所示，</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class ProxyUtils {
  public static void main(String[] args) {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>执行上述代码，我们得到CtrlProxy.class字节码文件，然后再利用反编译工具，反编译CtrlProxy.class字节码文件，于是，就得到对应的Java文件，如下所示。m3、m4对应IUserController接口中定义的方法，也就是login()和register()。m0、m1、m2为继承自顶级父类Object类的方法，也就是toString()、equals()、hashCode()。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public final class CtrlProxy extends Proxy implements IUserController {
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述代码中，类型为InvocationHandler的super.h的值，在实例化动态代理类对象时，赋值为自定义的InvocationHandler实现类对象（比如CtrlProxyHandler类对象）。如下简化之后的newProxyInstance()函数代码所示。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public static Object newProxyInstance(ClassLoader loader, Class&lt;?&gt;[] interfaces, InvocationHandler h) {
    // 1) 生成动态代理类
    // 2) 加载动态代理类
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当我们调用动态代理类上方法时，比如调用login()方法，login()方法会调用CtrlProxyHandler上的invoke()方法。invoke()方法执行一些附加逻辑，然后再拿传递过来的方法和参数，利用反射在原始类对象上执行，如下图所示。</p><figure><img src="http://wechatapppro-1252524126.file.myqcloud.com/appnvnpyonz2273/image/ueditor/43499800_1655395750.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p><strong>3）性能分析</strong></p><p>从上述对基于JDK实现动态代理的原理分析，我们可以发现，基于JDK实现动态代理，耗时的地方主要有两处：一是运行时动态生成代理类的字节码，二是利用反射执行方法。</p><p>对于反射执行方法的性能，我们在第24节讲解反射时已经分析过了。反射会额外增加一部分耗时，但如果方法中的逻辑比较复杂，执行时间比较长，那么相比而言，反射额外增加的耗时可以忽略。相反，如果方法中的逻辑比较简单，执行时间很短，那么反射额外增加的耗时就不能忽略了。对于动态生成代理类的字节码，可想而知，这部分耗时确实会比较多。对比静态代理，静态代理类的字节码是在编译时生成的，不占用运行时间。</p><h2 id="四、基于cglib实现动态代理" tabindex="-1"><a class="header-anchor" href="#四、基于cglib实现动态代理" aria-hidden="true">#</a> <strong>四、基于CGLIB实现动态代理</strong></h2><p>基于CGLIB实现动态代理，跟基于JDK实现动态代理相比，基本用法和实现原理非常类似。前面已经详细讲解了基于JDK的动态代理实现方式，接下来，我们对基于CGLIB的动态代理实现方式就简单介绍一下。</p><p>使用CGLIB需要先在项目中引入CGLIB包，Maven配置如下所示</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;!-- https://mvnrepository.com/artifact/cglib/cglib --&gt;
&lt;dependency&gt;
    &lt;groupId&gt;cglib&lt;/groupId&gt;
    &lt;artifactId&gt;cglib&lt;/artifactId&gt;
    &lt;version&gt;3.3.0&lt;/version&gt;
&lt;/dependency&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>基于CGLIB实现动态代理，也要用到一个核心接口MethodInterceptor和一个核心类Enhancer，它们的用法跟JDK中的InvocationHandler接口和Proxy类相似，示例代码如下所示。这里我就不详细讲解用法了，留给你自己查阅。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class ProxyFactory implements MethodInterceptor {
  private Object origBean;
